        ...
        <div class="mainpage3_third">
            <div class="mainpage3_third_filters">
                <div class="mainpage3_third_filters_location_filter">
                    ...
                    <svg v-bind:class="{ none: isNone }" height="400" width="500" viewBox=" 100 800 600" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                        ...
                        <g filter="url(#dropshadow2)"><text id="LCD11110" class="TEXT" x="399" y="277">종로구</text>
                ...
                <div class="mainpage3_third_filters_theme_filter">
                    <select name="items2">
                        ...
                        <option value="쇼룸,편집샵">쇼룸,편집샵</option>
