    ...
    <div class="join">
        ...
        <div class="wrap">
            <form @submit.prevent="joinForm">
                ...
                <input v-model="email" type="text" id="email" placeholder="이메일 입력" class="width" maxlength="25">
                ...
                <input v-model="password" type="password" id="password" placeholder="비밀번호 입력" maxlength="15"><br />
                ...
                <input  @input="nickname = $event.target.value" type="text" id="nickname" placeholder="활동명 입력" class="width" maxlength="10">
                ...
                <input v-model="phone_num" type="text" id="phone_num" placeholder="전화번호 입력" maxlength="11"><br />
