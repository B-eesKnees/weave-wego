...
router.post("/getLikeCourse", async (req, res) => {
  db.query(
    `SELECT board.BRD_ID, board.BRD_WRITER, board.BRD_HASHTAG, board.BRD_NICK, board.BRD_TITLE, board.BRD_CREATED_AT, board.BRD_VIEWCOUNT, (SELECT IMG_PATH FROM weavewego.image 
